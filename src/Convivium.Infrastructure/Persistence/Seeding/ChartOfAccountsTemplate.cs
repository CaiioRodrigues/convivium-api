...
public static class ChartOfAccountsTemplate
{
    ...
    [
        ...
        new("4.4", "Aluguel de Areas Comuns", AccountNature.Revenue, IsApportionable: false),
        ...
        new("5.1.01", "Salarios", AccountNature.Expense),
        new("5.1.02", "Encargos Sociais", AccountNature.Expense),
        new("5.1.03", "Beneficios", AccountNature.Expense),
        new("5.1.04", "Ferias e Rescisoes", AccountNature.Expense),

        // --- Concessionarias: e aqui que caem as faturas lidas de PDF ---
        new("5.2", "Concessionarias", AccountNature.Expense, IsGroup: true),
        new("5.2.01", "Energia Eletrica", AccountNature.Expense),
        new("5.2.02", "Agua e Esgoto", AccountNature.Expense),
        new("5.2.03", "Gas", AccountNature.Expense),
        new("5.2.04", "Telefone e Internet", AccountNature.Expense),

        // --- Manutencao ---
        new("5.3", "Manutencao e Conservacao", AccountNature.Expense, IsGroup: true),
        new("5.3.01", "Elevadores", AccountNature.Expense),
        new("5.3.02", "Portao, Interfone e CFTV", AccountNature.Expense),
        new("5.3.03", "Jardinagem", AccountNature.Expense),
        new("5.3.04", "Piscina", AccountNature.Expense),
        new("5.3.05", "Hidraulica e Eletrica", AccountNature.Expense),
        new("5.3.06", "Dedetizacao e Limpeza de Caixa d'Agua", AccountNature.Expense),

        // --- Terceirizados ---
        new("5.4", "Servicos Terceirizados", AccountNature.Expense, IsGroup: true),
        new("5.4.01", "Portaria e Seguranca", AccountNature.Expense),
        new("5.4.02", "Limpeza e Conservacao", AccountNature.Expense),
        new("5.4.03", "Administradora", AccountNature.Expense),
        new("5.4.04", "Contabilidade e Juridico", AccountNature.Expense),
